...
public class StreamingAgent : AgentApplication
{
    ...
    public StreamingAgent(AgentApplicationOptions options, IConversationReferenceStore store) : base(options)
    {
        ...
        OnActivity(ActivityTypes.Event, OnEvent, rank: RouteRank.Last);
    }
    ...
    private async Task OnEvent(ITurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    {
        Console.WriteLine($"Received activity of type: {turnContext.Activity.Type}");
    ...
    private async Task OnMessageAsync(ITurnContext turnContext, ITurnState turnState, CancellationToken cancellationToken)
    {
        try
        {
            ...
            turnContext.StreamingResponse.QueueTextChunk("Did this work?");
        ...
        finally
        {
            ...
            await _store.SaveAsync(reference.Conversation.Id, reference);
        }
    }
}